...
public abstract class BaseDataActivity<B extends ViewDataBinding> extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            viewBinding = ((B) inflate.invoke(null, getLayoutInflater()));
...
//            BusUtils.register(this);
    ...
    protected void initImmersionBar(int color) {
        ImmersionBar.with(this).transparentStatusBar().statusBarColor(color).autoStatusBarDarkModeEnable(true, 0.2f).fitsSystemWindows(true).init();
