 ...
 * 通用dialog
 */
public abstract class BaseDialog extends Dialog implements androidx.lifecycle.LifecycleObserver {
    ...
    protected int getWidth() {
        return (int) (com.blankj.utilcode.util.ScreenUtils.getScreenWidth() * 0.9);
    }
